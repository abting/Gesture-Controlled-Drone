...
def main(unused_argv):
    ...
    #onehot_labels = tf.one_hot(indices=tf.cast(Y_train, tf.int32), depth=3)
    #
    #with tf.Session() as sess:
    #    print (sess.run(onehot_labels)[50])
    
    #   Create the Estimator
    mnist_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn, model_dir="temp/")
